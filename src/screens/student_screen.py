...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
                if st.button("Unenroll from tihs course", type='tertiary', width='stretch', key=f"unenroll_{sub['subject_id']}", icon=':material/delete_forever:'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, My name is Amaan.....')
            except Exception:
